"""
Script to set globals needed for generate_ultimate_thumbnails
...
def set_default_properties(event_info=None):
    """
    Function to set default properties for globals needed for generate_ultimate_thumbnails.py
    :return:
    """
    ...
    properties['render_type'] = "Ultimate_Body_render"
...
def setGlobalsQuarantainment(weekly_event):
    """
    Set necessary globals for Quarantainment event {number} for generate_ultimate_thumbnails.py
    ...
    # Character renders folder location
    properties['render_type'] = "Ultimate_Full_render"
    # Background and Foreground overlay locations
...
def setGlobalsSxT(weekly_event):
    """
    Set necessary globals for Students x Treehouse event {number} for generate_ultimate_thumbnails.py
    properties dictionary is fed in, modified, then returned
    :param weekly_event:
    :return:
    """
...
def setGlobalsFro(weekly_event):
    """
    Set all globals for Fro Friday event {number} for generate_ultimate_thumbnails.py
    properties dictionary is fed in, modified, then returned
    :param weekly_event:
    :return:
    """
...
def setGlobalsAWG(weekly_event):
    """
    Set all globals for AWG event {number} for generate_ultimate_thumbnails.py
    properties dictionary is fed in, modified, then returned
    :param weekly_event:
    :return:
    """
...
def setGlobalsCatman(weekly_event):
    """
    Set necessary globals for Catman event {number} for generate_ultimate_thumbnails.py
    properties dictionary is fed in, modified, then returned
    :param weekly_event:
    :return:
    """
...
def setGlobalsIzAw(weekly_event):
    """
    Set necessary globals for IzAw Sub event {number} for generate_ultimate_thumbnails.py
    properties dictionary is fed in, modified, then returned
    :param weekly_event:
    :return:
    """
...
def setGlobalsIFN(weekly_event):
    """
    Set necessary globals for Immortal Fight Night {number} for generate_ultimate_thumbnails.py
    properties dictionary is fed in, modified, then returned
    :param weekly_event:
    :return:
    """
...
def setGlobalsCRClash(weekly_event):
    """
    Set necessary globals for CR Clash {number} for generate_ultimate_thumbnails.py
    properties dictionary is fed in, modified, then returned
    :param weekly_event:
    :return:
    """
    ...
    properties['font_player1_size'] = 90  #42
    properties['font_player2_size'] = 90  #42
    properties['font_event_size'] = 80  #37 100
    properties['font_round_size'] = 95  #37
...
def setGlobalsQuarantainment_Top8():
    ...
    # Character renders folder location
    properties['render_type'] = "Ultimate_Body_render"
    properties['render_type2'] = "Ultimate_Diamond_render"
    # Event match file information location
