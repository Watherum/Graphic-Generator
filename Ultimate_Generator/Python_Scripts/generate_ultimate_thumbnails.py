...
def main(argv):
    ...
    try:
        ...
        print('generate_ultimate_thumbnails.py -e <event>, -p <property_file>, -o <output_file>')
        sys.exit(2)
    for opt, arg in opts:
        if opt == '-h':
            print('generate_ultimate_thumbnails.py -e <event (can have a number)>, -p <property_file>, -o <output_file>')
            sys.exit()
        elif opt in ("-e", "--event"):
            event_title = arg
