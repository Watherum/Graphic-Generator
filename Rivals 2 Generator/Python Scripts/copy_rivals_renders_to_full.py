...
into Resources/Character_Renders/Rivals 2 Full Renders/, keeping original filenames.
...
DEST_DIR    = SCRIPT_DIR / "Resources" / "Character_Renders" / "Rivals 2 Full Renders"
