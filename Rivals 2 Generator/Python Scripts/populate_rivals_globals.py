"""
Script to set globals needed for generate_rivals_thumbnail
...
def set_default_properties(event_info=None):
    """
    Function to set default properties for globals needed for generate_rivals_thumbnail.py
    :return:
    """
    ...
    properties['render_type'] = "Rivals 2 Full Renders"
...
def setGlobalsQuarantainment(weekly_event):
    """
    Set necessary globals for Quarantainment event {number} for generate_rivals_thumbnail.py
...
def setGlobalsSxT(weekly_event):
    """
    Set necessary globals for Students x Treehouse event {number} for generate_rivals_thumbnail.py
    properties dictionary is fed in, modified, then returned
    :param weekly_event:
    :return:
    """
...
def setGlobalsFro(weekly_event):
    """
    Set all globals for Fro Friday event {number} for generate_rivals_thumbnail.py
    properties dictionary is fed in, modified, then returned
    :param weekly_event:
    :return:
    """
...
def setGlobalsAWG(weekly_event):
    """
    Set all globals for AWG event {number} for generate_rivals_thumbnail.py
    properties dictionary is fed in, modified, then returned
    :param weekly_event:
    :return:
    """
...
def setGlobalsCatman(weekly_event):
    """
    Set necessary globals for Catman event {number} for generate_rivals_thumbnail.py
    properties dictionary is fed in, modified, then returned
    :param weekly_event:
    :return:
    """
...
def setGlobalsIzAw(weekly_event):
    """
    Set necessary globals for IzAw Sub event {number} for generate_rivals_thumbnail.py
    properties dictionary is fed in, modified, then returned
    :param weekly_event:
    :return:
    """
...
def setGlobalsStraightIntoTheAbyss(weekly_event):
    """
    Set necessary globals for Catman event {number} for generate_rivals_thumbnail.py
    properties dictionary is fed in, modified, then returned
    :param weekly_event:
    ...
    # Event shorthand name for what text is on the graphic
    properties['event_short_name'] = properties['event_name']
    # Character renders folder location
    properties['render_type'] = "Rivals 2 Full Renders"
    # Background and Foreground overlay locations
    properties['background_file'] = os.path.join("Resources", 'Overlays', 'Background_Abyss.png')
    properties['foreground_file'] = os.path.join("Resources", 'Overlays', 'Foreground_Abyss.png')
    # Center-point shift for canvas for characters
    properties['center_shift_1'] = (-0.00, +0.00) # Universal character shift
    # Center-point shift for canvas for characters
    properties['center_shift_2_1'] = (-0.00, +0.00)  # Two character shift
    ...
    properties['one_char_flag'] = False
    # Scaler Variables for characters in window
    properties['resize_1'] = 0.8  # resize for character for multiple renders on image
    properties['resize_2'] = 0.35
    properties['resize_3'] = 0.35
    # Canvas flag
    properties['char_glow_bool'] = False
    ...
    # Font settings
    properties['font_location'] = os.path.join("Resources", "Fonts", "Teko-Light.ttf")
    properties['font_player1_size'] = 150  #42
    properties['font_player2_size'] = 150 #42
    properties['font_event_size'] = 110  #37
    properties['font_round_size'] = 153  #37
    properties['font_color1'] = '#C90000'  # (201, 0, 0)
    properties['font_color2'] = '#C90000'  # (201, 0, 0)
    properties['font_color3'] = '#C90000'  # (201, 0, 0)
    properties['font_color4'] = '#C90000'  # (201, 0, 0)
...
def setGlobalsIFN(weekly_event):
    """
    Set necessary globals for Immortal Fight Night {number} for generate_rivals_thumbnail.py
    properties dictionary is fed in, modified, then returned
    :param weekly_event:
    :return:
    """
...
def setGlobalsTwistOfFate(weekly_event):
    """
    Set necessary globals for Twist of Fate {number} for generate_rivals_thumbnail.py
    properties dictionary is fed in, modified, then returned
    :param weekly_event:
    :return:
    """
    ...
    properties['render_type'] = "Rivals 2 Full Renders"
    # Background and Foreground overlay locations
    properties['background_file'] = os.path.join("Resources", 'Overlays', 'Background_TOF.png')
    properties['foreground_file'] = os.path.join("Resources", 'Overlays', 'Foreground_TOF.png')
    # Center-point shift for canvas for characters
    properties['center_shift_1'] = (-0.00, +0.00) # Universal character shift
    # Center-point shift for canvas for characters
    properties['center_shift_2_1'] = (-0.00, +0.00)  # Two character shift
    ...
    properties['text_angle'] = 0  # degree of rotation counter-clockwise
    # Font settings
    properties['font_location'] = os.path.join("Resources", "Fonts", "HKModular-Bold.otf")
    properties['font_player1_size'] = 65  #42
    properties['font_player2_size'] = 65 #42
    properties['font_event_size'] = 70  #37
    properties['font_round_size'] = 50  #37
...
def setGlobalsSuperFusion(weekly_event):
    """
    Set necessary globals for Super Fusion {number} for generate_rivals_thumbnail.py
    properties dictionary is fed in, modified, then returned
    :param weekly_event:
    :return:
    """
    ...
    # Event shorthand name for what text is on the graphic
    properties['event_short_name'] = properties['event_name']  # Super Fusion #
    # Character renders folder location
    properties['render_type'] = "Rivals 2 Full Renders"
    # Background and Foreground overlay locations 
    properties['background_file'] = os.path.join("Resources", 'Overlays', 'Background_SuperFusion.png')
    properties['foreground_file'] = os.path.join("Resources", 'Overlays', 'Foreground_SuperFusion.png')
    # Center-point shift for canvas for characters
    properties['center_shift_1'] = (-0.00, +0.25) # Universal character shift
    # Center-point shift for canvas for characters
    properties['center_shift_2_1'] = (-0.00, +0.00)  # Two character shift
    ...
    # Font settings
    properties['font_location'] = os.path.join("Resources", "Fonts", "Teko-Light.ttf")
    properties['font_player1_size'] = 95  #42
    properties['font_player2_size'] = 95  #42
    properties['font_event_size'] = 120  #37
    properties['font_round_size'] = 95  #37
    properties['font_color1'] = '#FFFFFF'  # (201, 0, 0)
    properties['font_color2'] = '#FFFFFF'  # (201, 0, 0)
    properties['font_color3'] = '#FFFFFF'  # (201, 0, 0)
...
def setGlobalsCRClash(weekly_event):
    """
    Set necessary globals for CR Clash {number} for generate_rivals_thumbnail.py
    properties dictionary is fed in, modified, then returned
    :param weekly_event:
    :return:
    """
...
def setGlobalsCRArcadian(weekly_event):
    """
    Set necessary globals for CR Arcadian {number} for generate_rivals_thumbnail.py
    properties dictionary is fed in, modified, then returned
    :param weekly_event:
    :return:
    """
...
def setGlobalsClipIt(weekly_event):
    """
    Set necessary globals for Clip it event {number} for generate_rivals_thumbnail.py
    properties dictionary is fed in, modified, then returned
    :param number:
    :return:
    """
...
def setGlobalsAbyss_Top8():
    """
    Set necessary globals for Straight Into the Abyss Top 8 Graphic for create_new_top8_graphic.py
    properties dictionary is fed in, modified, then returned
    :return:
    """
     # Load in default
    ...
    # Character renders folder location
    properties['render_type'] = "Rivals 2 Full Renders"
    properties['render_type2'] = "Rivals 2 Full Renders"
    # Event match file information location
    properties['top8_info'] = os.path.join('Top_8_Texts', 'Straight Into The Abyss_Top8.txt')
    # Background and Foreground overlay locations
    properties['background_file'] = os.path.join("Resources", 'Top8_Graphics', 'SITA_BACKGROUND.png')
    properties['foreground_file'] = os.path.join("Resources", 'Top8_Graphics', 'SITA _FOREGROUND.png')
    # Canvas flag
    properties['char_glow_bool'] = True
    # Center-point shift for canvas for characters
    properties['resize'] = 0.517578125
    ...
    properties['resize_2'] = 1.00
    # Placements for windows
    properties['char_window'] = (0.5, 0.5)  # canvas for characters
    properties['char_offset1'] = (-0.6, 0.1)  # Offset for 1
    properties['char_offset2'] = (0.07, 0.18)  # Offset for 2
    properties['char_offset3'] = (0.285, 0.18)  # Offset for 3
    ...
    properties['char_scale2'] = (0.475, 0.475)  # Offset for 2
    properties['char_scale3'] = (0.475, 0.475)  # Offset for 3
    properties['char_scale4'] = (0.475, 0.475)  # Offset for 4
    properties['char_scale5'] = (0.4, 0.4)  # Offset for 5
    properties['char_scale6'] = (0.4, 0.4)  # Offset for 6
    properties['char_scale7'] = (0.4, 0.4)  # Offset for 7
    properties['char_scale8'] = (0.4, 0.4)  # Offset for 8
    # Center-point shift for canvas for characters
    properties['center_shift_1'] = (+0.30, +0.00)  # Universal character shift
    properties['center_shift_2_1'] = (+0.00, +0.00)  # Two character shift
    properties['center_shift_2_2'] = (-0.38, +0.155)
    ...
    # Player Font settings
    properties['text_angle'] = 0
    properties['font_player_location'] = os.path.join("Resources", "Fonts", "HKModular-Bold.otf")
    properties['font_player_color'] = '#F5F5F5'  # (245, 245, 245)
    properties['font_player_align'] = 'center'
    ...
    properties['font_player_size7'] = 40
    properties['font_player_size8'] = 50
    properties['font_player1_offset'] = (0.18, 0.92)  # Offset for 1
    properties['font_player2_offset'] = (0.435, 0.6)  # Offset for 2
    properties['font_player3_offset'] = (0.655, 0.6)  # Offset for 3
    properties['font_player4_offset'] = (0.875, 0.6)  # Offset for 4
    properties['font_player5_offset'] = (0.411, 0.93)  # Offset for 5
    properties['font_player6_offset'] = (0.575, 0.93)  # Offset for 6
    properties['font_player7_offset'] = (0.74, 0.93)  # Offset for 7
    properties['font_player8_offset'] = (0.9, 0.93)  # Offset for 8
    # Twitter Font settings
    properties['font_twitter_location'] = os.path.join("Resources", "Fonts", "HKModular-Bold.otf")
    properties['font_twitter_color'] = "#FFd700"  # (255, 255, 255)
    properties['font_twitter_back_color'] = '#00000000'  # (0, 0, 0, 25)
    properties['font_twitter_align'] = 'center'
    properties['font_twitter_size'] = 32
    properties['font_twitter_size1'] = 32
    properties['font_twitter_size2'] = 32
    properties['font_twitter_size3'] = 32
    properties['font_twitter_size4'] = 32
    properties['font_twitter_size5'] = 30
    properties['font_twitter_size6'] = 32
    properties['font_twitter_size7'] = 32
    properties['font_twitter_size8'] = 32
    properties['font_twitter1_offset'] = (0.18, 0.873)  # Offset for 1
    properties['font_twitter2_offset'] = (0.435, 0.555)  # Offset for 2
    properties['font_twitter3_offset'] = (0.65, 0.555)  # Offset for 3
    properties['font_twitter4_offset'] = (0.875, 0.555)  # Offset for 4
    properties['font_twitter5_offset'] = (0.411, 0.89)  # Offset for 5
    properties['font_twitter6_offset'] = (0.575, 0.89)  # Offset for 6
    properties['font_twitter7_offset'] = (0.74, 0.89)  # Offset for 7
    properties['font_twitter8_offset'] = (0.9, 0.89)  # Offset for 8
    # Media Info settings
    properties['font_media_location'] = os.path.join("Resources", "Fonts", "HKModular-Bold.otf")
    properties['font_media_color'] = '#FFFFFF'  # (5, 5, 5)
    properties['font_media_align'] = 'center'
    properties['font_media_size'] = 40
    properties['font_media_twitter_offset'] = (0.855, 0.79)
    properties['font_media_youtube_offset'] = (0.855, 0.855)
    properties['font_media_twitch_offset'] = (0.855, 0.915)
    properties['font_media_bracket_link_offset'] = (0.50, 0.137)
    # Event Info settings
    properties['font_event_location'] = os.path.join("Resources", "Fonts", "HKModular-Bold.otf")
    properties['font_event_name_offset'] = (0.50, 0.08)
    properties['font_event_name_color'] = "#000000"  # (5, 5, 5)
    properties['font_event_name_size'] = 55
    properties['font_event_name_align'] = 'center'
    properties['font_event_date_offset'] = (0.5, 0.24)
    properties['font_event_date_color'] = '#FFFFFF'  # (5, 5, 5)
    properties['font_event_date_size'] = 40
    properties['font_event_date_align'] = 'center'
    properties['font_event_entrants_offset'] = (0.5, 0.19)
    properties['font_event_entrants_color'] = '#FFFFFF'  # (5, 5, 5)
    properties['font_event_entrants_size'] = 40
    properties['font_event_entrants_align'] = 'center'
    # Set to Watch Info settings
    properties['font_stw_location'] = os.path.join("Resources", "Fonts", "HKModular-Bold.otf")
    properties['font_stw_color'] = '#FFFFFF'  # (5, 5, 5)
    properties['font_stw_align'] = 'center'
    properties['font_stw_size'] = 45
    properties['font_stw_twolines'] = True
    properties['font_stw_line1_offset'] = (0.8345, 0.645)
    properties['font_stw_line2_offset'] = (0.8345, 0.705)
